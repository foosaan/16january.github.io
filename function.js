...
_.prototype = {
  ...
  get flower() {
    ...
    flower.style.opacity = 0.9; // Initial opacity
    for (var i = 0; i < 5; i++) {
      var petal = this.petal;
      var styles = this.petal_styles[i];
      petal.style.transform = styles["transform"];
      petal.style.top = styles["top"];
      petal.style.left = styles["left"];
      petal.style.marginLeft = styles["marginLeft"];
